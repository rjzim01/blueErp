    ...
    <div class="space-y-6">
            ...
            <div class="relative overflow-hidden rounded-xl shadow-lg p-5" style="background-color: #28a745;">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-white text-2xl font-bold mt-1"><?php echo e(number_format($cashbalance)); ?>/-</p>
                    </div>
                ...
                <div class="mt-4 pt-3 border-t border-white/20">
                    <a href="<?php echo e(route('filament.admin.resources.balances.index')); ?>" class="text-white/90 text-sm hover:text-white flex items-center gap-1">
                        View Details
            ...
            <div class="relative overflow-hidden rounded-xl shadow-lg p-5" style="background-color: #17a2b8;">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-white text-2xl font-bold mt-1"><?php echo e(number_format($citybalance)); ?>/-</p>
                    </div>
                    <div class="text-white/60">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="relative overflow-hidden rounded-xl shadow-lg p-5" style="background-color: #ffc107;">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-white text-2xl font-bold mt-1"><?php echo e(number_format($dbblbalance)); ?>/-</p>
                    </div>
                    <div class="text-white/60">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="relative overflow-hidden rounded-xl shadow-lg p-5" style="background-color: #6f42c1;">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-white text-2xl font-bold mt-1"><?php echo e(number_format($islamibankbalance)); ?>/-</p>
                    </div>
                    <div class="text-white/60">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            ...
            <div class="relative overflow-hidden rounded-xl shadow-lg p-5" style="background-color: #343a40;">
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-white text-2xl font-bold mt-1"><?php echo e(number_format($bankasiabalance)); ?>/-</p>
                    </div>
                    <div class="text-white/60">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 pl-20">
                ...
                <p class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e(number_format($products)); ?></p>
            </div>

            
            <a href="<?php echo e(route('filament.admin.resources.product-archives.index')); ?>" class="block">
                <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 pl-20 hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e(number_format($barcodes)); ?></p>
                </div>
            </a>
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 pl-20">
                ...
                <p class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e(number_format($todaysell)); ?></p>
            </div>
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 pl-20">
                ...
                <p class="text-gray-900 dark:text-white text-2xl font-bold"><?php echo e(number_format($todayreturn)); ?></p>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border-l-4" style="border-left-color: #28a745;">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e(number_format($todays_sell_amount)); ?>/-</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border-l-4" style="border-left-color: #dc3545;">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e(number_format($todays_return_amount)); ?>/-</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border-l-4" style="border-left-color: #ffc107;">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e(number_format($net_sell_amount)); ?>/-</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border-l-4" style="border-left-color: #28a745;">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e(number_format($todays_sell_qtt)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border-l-4" style="border-left-color: #dc3545;">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e(number_format($todays_return_qtt)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-5 border-l-4" style="border-left-color: #ffc107;">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 dark:text-white text-xl font-bold"><?php echo e(number_format($net_sell_qtt)); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('filament.admin.resources.customers.index')); ?>" class="inline-flex items-center px-5 py-3 rounded-full font-semibold text-white shadow-md hover:shadow-lg transition-all" style="background-color: #28a745;">
            ...
            <a href="<?php echo e(route('filament.admin.resources.stocks.index')); ?>" class="inline-flex items-center px-5 py-3 rounded-full font-semibold text-white shadow-md hover:shadow-lg transition-all" style="background-color: #007bff;">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Go To Stock Report
            </a>
            <a href="<?php echo e(route('filament.admin.resources.stock-entries.create')); ?>" class="inline-flex items-center px-5 py-3 rounded-full font-semibold text-white shadow-md hover:shadow-lg transition-all" style="background-color: #28a745;">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                Go To Old Stock Entry
            </a>
            <a href="<?php echo e(route('filament.admin.resources.balances.index')); ?>" class="inline-flex items-center px-5 py-3 rounded-full font-semibold text-white shadow-md hover:shadow-lg transition-all" style="background-color: #dc3545;">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['total_prduction'] ?? 0)); ?></p>
                </div>
                <div class="bg-yellow-50 dark:bg-yellow-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['total_warehouse'] ?? 0)); ?></p>
                </div>
                <div class="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['total_transfer'] ?? 0)); ?></p>
                </div>
                <div class="bg-green-50 dark:bg-green-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['total_outlet_stock'] ?? 0)); ?></p>
                </div>
                <div class="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['total_sold'] ?? 0)); ?>/-</p>
                </div>
                <div class="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-4 text-center">
                    <p class="text-sm text-purple-700 dark:text-purple-400">Order Sell</p>
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['total_order'] ?? 0)); ?>/-</p>
                </div>
                <div class="bg-orange-50 dark:bg-orange-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['total_damaged'] ?? 0)); ?></p>
                </div>
                <div class="bg-red-50 dark:bg-red-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['stock_error'] ?? 0)); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-indigo-50 dark:bg-indigo-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($distribution['warehouse_amount'] ?? 0)); ?>/-</p>
                ...
                <div class="bg-emerald-50 dark:bg-emerald-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format(($distribution['total_sold'] ?? 0) + ($distribution['total_order'] ?? 0))); ?>/-</p>
                ...
                <div class="bg-rose-50 dark:bg-rose-900/30 rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format(($distribution['total_damaged'] ?? 0) + ($distribution['stock_error'] ?? 0))); ?>/-</p>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $outlet_wise_sell; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e($index + 1); ?></td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e($item['name']); ?></td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($item['pos_sell'], 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($item['order_sell'], 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($item['return'], 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($item['order_cancelled'], 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($item['net_sell'], 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($item['expense'], 0)); ?>/-</td>
                            </tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($outlet_wise_sell) > 0): ?>
                            <tr class="bg-gray-100 dark:bg-gray-800 font-semibold">
                                <td colspan="2" class="px-4 py-3 text-gray-900 dark:text-gray-100">Total</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($outlet_wise_report_summery['pos_ttl'] ?? 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($outlet_wise_report_summery['order_ttl'] ?? 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($outlet_wise_report_summery['ret_ttl'] ?? 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($outlet_wise_report_summery['cancel_ttl'] ?? 0)); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format(($outlet_wise_report_summery['pos_ttl'] ?? 0) + ($outlet_wise_report_summery['order_ttl'] ?? 0) - ($outlet_wise_report_summery['ret_ttl'] ?? 0) - ($outlet_wise_report_summery['cancel_ttl'] ?? 0))); ?>/-</td>
                                <td class="px-4 py-3 text-gray-900 dark:text-gray-100"><?php echo e(number_format($outlet_wise_report_summery['expense_ttl'] ?? 0)); ?>/-</td>
                            </tr>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </tbody>
                </table>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/filament/pages/dashboard.blade.php ENDPATH**/ ?>